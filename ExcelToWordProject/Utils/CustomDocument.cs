    ...
    internal class CustomDocument
    {
            ...
            List<string> stringList = new List<string>()
      {
        ...
        "application/vnd.openxmlformats-package.relationships+xml"
            ...
            {
                if (!stringList.Contains(packagePart1.ContentType) && !_imageContentTypes.Contains(packagePart1.ContentType))
                {
                    if (this._package.PartExists(packagePart1.Uri))
                    {
                        ...
                        switch (packagePart1.ContentType)
                        {
                            case "application/vnd.ms-word.stylesWithEffects+xml":
                                this.merge_styles(packagePart1, part, remote_mainDoc, remote_document.Document, remote_footnotes, remote_endnotes, mergingMode);
                                break;
                            ...
                            case "application/vnd.openxmlformats-officedocument.wordprocessingml.endnotes+xml":
                                this.merge_endnotes(packagePart1, part, remote_mainDoc, remote_document.Document, remote_endnotes);
                                break;
                            ...
                            case "application/vnd.openxmlformats-officedocument.wordprocessingml.footnotes+xml":
                                this.merge_footnotes(packagePart1, part, remote_mainDoc, remote_document.Document, remote_footnotes);
                                break;
                            ...
                            case "application/vnd.openxmlformats-officedocument.wordprocessingml.styles+xml":
                                this.merge_styles(packagePart1, part, remote_mainDoc, remote_document.Document, this._footnotes, this._endnotes, mergingMode);
                                break;
                        }
                    }
                    else
            ...
            foreach (PackageRelationship packageRelationship in remote_document.Document.PackagePart.GetRelationshipsByType("http://schemas.openxmlformats.org/officeDocument/2006/relationships/hyperlink"))
            {
                string id1 = packageRelationship.Id;
                string id2 = Document.PackagePart.CreateRelationship(packageRelationship.TargetUri, packageRelationship.TargetMode, packageRelationship.RelationshipType).Id;
            ...
            foreach (PackageRelationship packageRelationship in remote_document.Document.PackagePart.GetRelationshipsByType("http://schemas.openxmlformats.org/officeDocument/2006/relationships/oleObject"))
            {
                string id3 = packageRelationship.Id;
                string id4 = Document.PackagePart.CreateRelationship(packageRelationship.TargetUri, packageRelationship.TargetMode, packageRelationship.RelationshipType).Id;
            ...
            PackageRelationshipCollection relationshipsByType1 = remote_document.Document.PackagePart.GetRelationshipsByType("http://schemas.openxmlformats.org/officeDocument/2006/relationships/numbering");
            PackageRelationshipCollection relationshipsByType2 = Document.PackagePart.GetRelationshipsByType("http://schemas.openxmlformats.org/officeDocument/2006/relationships/numbering");
            if (relationshipsByType1.Count<PackageRelationship>() > 0 && relationshipsByType2.Count<PackageRelationship>() == 0)
            {
                foreach (PackageRelationship packageRelationship in relationshipsByType1)
                    Document.PackagePart.CreateRelationship(packageRelationship.TargetUri, packageRelationship.TargetMode, packageRelationship.RelationshipType);
            }
            if (remote_document._fontTablePart != null && this._fontTablePart != null)
            {
                ...
                if (relationshipsByType3.Count<PackageRelationship>() > 0 && relationshipsByType4.Count<PackageRelationship>() == 0)
                {
                    foreach (PackageRelationship packageRelationship in relationshipsByType3)
                        this._fontTablePart.CreateRelationship(packageRelationship.TargetUri, packageRelationship.TargetMode, packageRelationship.RelationshipType);
                }
            }
